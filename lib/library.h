...
int my_str_read_file_delim(my_str* str, FILE* file, char delimiter); // Done
int my_str_write(const my_str* str, FILE* file); // Done
...
int my_str_reserve(my_str* str, size_t buf_size); // Done
int my_str_substr_cstr(const my_str* from, char* to, size_t beg, size_t end); // Done
...
const char* my_str_get_cstr(my_str* str); // Done
